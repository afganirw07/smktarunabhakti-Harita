              ...
              {!isEmailSent ? (
                ...
                >
                  ...
                  >
                    <motion.div 
                      ...
                      className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-green-400 to-green-600 rounded-full mb-4 shadow-lg"
                    >
                      <motion.div
                        animate={{ 
                          rotate: [0, 5, -5, 0],
                    ...
                    >
                      ...
                      >
                        <input
                          ...
                          required
                          className="w-full px-4 py-3 bg-white border border-green-200 rounded-lg text-sm font-medium placeholder-gray-400 focus:border-green-400 focus:ring-4 focus:ring-green-100 focus:outline-none transition-all duration-200 font-nunito"
                        />
                        <motion.div
                          animate={{
                            x: email ? 0 : [0, 2, -2, 0],
                ...
                >
                  <motion.div 
                    ...
                    className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-green-400 to-green-600 rounded-full mb-6 shadow-lg"
                  >
                    <motion.div
                  ...
                  >
                    <motion.button
                      ...
                      className="w-full bg-green-100 hover:bg-green-200 text-green-700 font-semibold py-3 px-4 rounded-lg transition-all duration-200 font-inter shadow-md hover:shadow-lg"
                    >
                      Kirim Ulang Email
                    </motion.button>
                    <motion.div
                    ...
                    >
                      <Link 
                        href="/auth/login"
                        className="block w-full text-center text-green-700 hover:text-green-800 font-medium py-2 transition-colors duration-200 font-nunito"
                      >
                        Kembali ke Login
                      </Link>
                    </motion.div>
