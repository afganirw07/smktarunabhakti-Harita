  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative m-0 flex max-w-screen-xl flex-1 justify-center overflow-hidden bg-white shadow sm:m-6 sm:rounded-lg"
      >
        ...
        >
          ...
          >
            <motion.h1
              ...
              className="mb-4 font-inter text-xl font-extrabold xl:text-2xl"
            >
              Daftar
            </motion.h1>
            ...
            >
              ...
              <AnimatePresence>
                {error && (
                  <motion.div
                    ...
                    className="mb-4 rounded-lg border border-red-200 bg-red-50 p-3 text-center text-sm text-red-500"
                  >
              ...
              >
                <div className="space-y-3">
                  ...
                  >
                    <motion.input
                      ...
                      transition={{ duration: 0.2 }}
                      className="w-full rounded-lg border border-green-200 bg-white px-5 py-3 font-nunito text-sm font-medium placeholder-gray-500 focus:border-green-400 focus:bg-white focus:outline-none focus:ring-4 focus:ring-green-100"
                      type="text"
                  ...
                  >
                    <motion.input
                      whileFocus={{ scale: 1.02, borderColor: '#4ade80' }}
                      transition={{ duration: 0.2 }}
                      className="w-full rounded-lg border border-green-200 bg-white px-5 py-3 pr-12 font-nunito text-sm font-medium placeholder-gray-500 focus:border-green-400 focus:bg-white focus:outline-none focus:ring-4 focus:ring-green-100"
                      type={show ? 'text' : 'password'} // 🔑 pakai state show
                      placeholder="Kata Sandi"
                      value={password}
                      onChange={(e) => setPassword(e.target.value)}
                    />

                    {/* Toggle button (Eye / EyeClosed) */}
                    <button
                      type="button"
                ...
                >
                  ...
                  <motion.button
                    ...
                    transition={{ duration: 0.2 }}
                    type="submit"
                    className="focus:shadow-outline mt-5 flex w-full items-center justify-center rounded-lg py-3 font-inter font-semibold tracking-wide text-white shadow-lg transition-all duration-300 ease-in-out focus:outline-none disabled:cursor-not-allowed disabled:opacity-50"
                    ...
                    {loading ? (
                      ...
                      >
                        <motion.div
                          ...
                          className="border-t-transparent mr-2 h-4 w-4 rounded-full border-2 border-white"
                        />
                  ...
                  >
                    ...
                    >
                      <Link href={'/auth/login'}>
                        <span className="font-nunito font-bold text-green-700 transition-colors duration-150 ease-out hover:text-green-500">
                          masuk
                        </span>
                      </Link>
                    </motion.span>
              ...
              <motion.p
                ...
                className="mt-4 text-center font-nunito text-xs text-gray-600"
              >
          ...
          >
            <div className="max-w-md text-center">
              ...
              <motion.h2
                ...
                className="mb-4 font-inter text-2xl font-bold xl:text-3xl"
              >
                Selamat Datang di{' '}
                <motion.span
                  animate={{
              ...
              <motion.p
                ...
                className="mb-6 font-nunito text-base leading-relaxed text-gray-200 xl:text-lg"
              >
              ...
              >
                <p className="mb-4 font-nunito text-sm text-gray-200">
                  Sudah memiliki akun?
                </p>
                <Link href="/auth/login">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    transition={{ duration: 0.2 }}
                    className="rounded-lg bg-white px-8 py-2 font-inter font-semibold text-green-700 shadow-lg transition-all duration-300 ease-in-out hover:bg-green-800 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-50"
                  >
                    Masuk
                  </motion.button>
                </Link>
