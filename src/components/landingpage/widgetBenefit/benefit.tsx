...
const Benefit = ({ Icon = User, Name = "Lorem ipsum ", Desc = "Lorem Ipsum Domet domet sir alet domet apa aja wpi anadn  " }) => {
  return (
    <div className="max-w-[400px] min-w-[320px] bg-white h-auto p-4 rounded-2xl shadow-md flex gap-4 ">
